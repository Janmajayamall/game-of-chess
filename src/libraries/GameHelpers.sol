...
library GameHelpers {
    ...
    function parseUintToPieceChar(uint val) internal returns (string memory ){
    ...
    function parseGameStateToFenString(IGocDataTypes.GameState memory gameState) internal returns (string memory fen){
        uint[] memory boardMap = new uint[](64);
